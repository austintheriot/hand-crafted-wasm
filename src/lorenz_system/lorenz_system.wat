(module
  ...
  (global $VIEW_DISTANCE f64 (f64.const 100))
  (global $DT f64 (f64.const 0.01))
  (global $X_THETA (mut f64) (f64.const 0))
  (global $SCALE (mut f64) (f64.const 0.02))
 ...
 (func $init_vertices
  ...
  (func $update_vertex (param $vertex_num i32)
    ...
    (local.set $P (f64.const 10))
    (local.set $R (f64.const 28))
    (local.set $B (f64.div (f64.const 8) (f64.const 3)))
